...
const LoginPage = () => {
    ...
    return (
      <div className="max-w-5xl mx-auto flex flex-col gap-10 pb-20">
        ...
        <div className="flex flex-col items-center">
          {/* Card do Supervisor com bordas e fundos baseados no Azul Escuro Moura e detalhes em Amarelo */}
  ...
  return (
    /* Fundo alterado para um tom profundíssimo da escala de azuis Moura (#000a1a) */
    <div className="min-h-screen bg-[#000a1a] text-white p-4 md:p-8 flex items-center justify-center relative overflow-hidden font-sans selection:bg-[#006CB0]">
      ...
      {/* Brilhos (Glows) de fundo usando Azul Escuro Moura e Azul Médio Moura */}
