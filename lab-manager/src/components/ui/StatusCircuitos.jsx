...
const UsageStatsModal = ({ isOpen, onClose, baths = [] }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-[65rem] overflow-hidden border border-slate-200 flex flex-col md:flex-row max-h-[96vh] animate-in zoom-in-95 duration-300">
        ...
        <div className="w-full md:w-1/2 p-8 bg-slate-50 flex flex-col items-center justify-center border-b md:border-b-0 md:border-r border-slate-200 relative min-h-[300px]">
          ...
          <div className="h-80 w-80 relative mt-4">
            {stats.total > 0 ? (
